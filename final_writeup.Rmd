...
* Remove countries that the US is at war with and run Terman's models
* Remove articles containing keywords related to acts of terrorism and run Terman's models
I hypothesize that Terman's results are partly driven by coverage of warzones or terrorist acts, and thus by removing these it will lessen the magnitude of her results.
