...
fig3m <- sean_graph(list(nb1, wnb1, text_nb1), labels = c("All Data", "No Warzones", "No Terrorism"), title = "Marginal effects plot", xlabel = "Muslim Majority", ylabel = "Marginal Effect of Women's Rights on Coverage")
...
fig4m <- sean_graph(list(nb1, wnb1, text_nb1, bothModels_nb1), labels = c("All Data", "No Warzones", "No Terrorism", "No war, No Terror"), title = "Marginal effects plot", xlabel = "Muslim Majority", ylabel = "Marginal Effect of Women's Rights on Coverage")
