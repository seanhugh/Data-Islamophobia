...
sean_graph(list(nb1, wnb1), labels = c("No Warzones", "All Data"), title = "Marginal effects plot", xlabel = "Muslim Majority", ylabel = "Marginal Effect of Women's Rights on Coverage")
